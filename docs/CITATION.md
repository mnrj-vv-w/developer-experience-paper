...
本論考に含まれるデータを引用する場合：
```
森　龍二. (2025). Developer Experience Hidden Cost Analysis [Data set]. GitHub. https://github.com/mnrj-vv-w/developer-experience-paper/tree/main/assets/data
```
...
学術利用、データ利用等のお問い合わせ：
- GitHub Issue: https://github.com/mnrj-vv-w/developer-experience-paper/issues
...
### ブログ記事での引用
```markdown
森　龍二氏は、開発者ツールの不安定性について
「VCの短期圧力が根本原因」と分析している[1]。

[1] 森　龍二 (2025)「40年の謎：なぜTRONは安定し...」
...
スライドフッター：
```
出典: 森　龍二 (2025) "Developer Experience Paper"
```
